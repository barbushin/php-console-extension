 ...
 */
chrome.tabs.sendMessage = function(tabId, data) {
};
 ...
 * @param {string} event
 */
chrome.experimental.rlz.recordProductEvent = function(product, accessPoint, event) {
};
 ...
 */
chrome.experimental.rlz.sendFinancialPing = function(product, accessPoints, signature, brand, id, lang, excludeMachineId, callback) {
};
